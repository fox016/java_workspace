...
class DatabaseFacade implements PersistenceFacade
{
	...
	private static final String databasePath = "jdbc:sqlite:./HIT_Database.sqlite";
	...
	*/
	...
	public void updateLastIds()
	{
		try
		{
			PreparedStatement clearIdStmt = connection().prepareStatement(SqlStatement.clearIds);
			clearIdStmt.execute();
		}catch(SQLException e)
		{
			System.out.println("Clear IDs failed: " + e.getMessage());
		}
		try
		{
