...
public class DatabaseCreator implements PersistenceCreator
{
	...
	*/
	...
	{
		return new DatabaseItemDataObject(item);
	}
	...
	*/
	...
	{
		return new DatabaseProductDataObject(product);
	}
	...
	*/
	...
	{
		return new DatabaseGroupDataObject(group);
	}
	...
	*/
	...
	{
		return new DatabaseUnitDataObject(unit);
	}
