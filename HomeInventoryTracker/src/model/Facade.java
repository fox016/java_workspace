...
public class Facade extends Observable
{
	...
	public static void addBatchItems(List<Item> items) throws ClassNotFoundException, SQLException {
		FacadeAdd.addBatchItems(items);
	}

        public static void addItem(Item item, StorageUnit storageUnit)
        {
            FacadeAdd.addItem(item, storageUnit);
        }
        
        public static Item createItem(Product p, Calendar entry, StorageUnit unit)
        {
            return FacadeAdd.createItem(p, entry, unit);
        }
	...
	public static boolean canAddStorageUnit(String unitName) {
        ...
        {
                FacadeAdd.createProduct(product);
        }
        
        public static void uneradicateItem(Item i)
        {
            FacadeAdd.uneradicateItem(i);
        }
        
        public static void eradicateItem(Item i) 
        {
            FacadeDelete.eradicateItem(i);
        }
        
        public static void commitItemBatch() 
        {
            FacadeAdd.commitItemBatch();
        }
