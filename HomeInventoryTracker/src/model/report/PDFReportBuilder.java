...
class PDFReportBuilder implements ReportBuilder
{
	...
	*/
	public void writeTitle(String title) throws IOException
	{
		...
		try
		{
			...
			Paragraph titlePar = new Paragraph(title, titleFont);
	...
	*/
	public void writeTableHeader(String[] headers) throws IOException
	{
		...
		for(String headerContent: headers)
		{
			PdfPCell cell = new PdfPCell(new Phrase(headerContent, headerFont));
			table.addCell(cell);
		}
	}
	...
	*/
	public void open(String filename) throws IOException
	{
		...
		filename = name + rand.nextInt() + ".pdf";
