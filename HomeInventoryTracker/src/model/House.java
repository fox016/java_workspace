...
public class House implements Serializable
{
	...
	private Calendar removedReportLastTime;
	...
	private House()
	{
		...
		//removedReportLastTime = Calendar.getInstance();
	}
    ...
    /**
     * Restores data that has been deserialized
     * 
     */
    public void restoreSingletons() 
    {
        ...
        //if(removedReportLastTime == null)
        	//removedReportLastTime = Calendar.getInstance();
    }

	/**
	 * @return Last time removed report was run
	 */
	public Calendar getRemovedReportLastTime() {
		return removedReportLastTime;
	}

	/**
	 * Sets the last time the removed report was run
	 * 
	 * @param removedReportLastTime
	 */
	public void setRemovedReportLastTime(Calendar removedReportLastTime) {
		this.removedReportLastTime = removedReportLastTime;
	}
}
