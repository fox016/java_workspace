...
public abstract class LocationView extends DialogView {
	...
	public LocationView(GUI parent, DialogBox dialog) {
		super(parent, dialog);
	}
	...
	private void createAddPanel() {
		...
		_nameLabel = new JLabel("Location Name:");
	...
	public void enableLocationName(boolean value) {
