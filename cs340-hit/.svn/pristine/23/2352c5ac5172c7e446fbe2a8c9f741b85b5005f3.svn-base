...
public final class GUI extends JFrame implements IMainView {
    ...
    public static void main(final String[] args) {
		...
		{
			model.persistence.PersistenceFactory.configure(new model.persistence.DatabaseCreator());
			System.out.println("Using Database Persistence");
		}
		else
		{
			model.persistence.PersistenceFactory.configure(new model.persistence.SerializationCreator());
			System.out.println("Using Serialization Persistence");
		}
