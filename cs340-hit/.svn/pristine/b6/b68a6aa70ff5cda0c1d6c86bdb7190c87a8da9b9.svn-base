...
DROP TABLE IF EXISTS containerToChild;
DROP TABLE IF EXISTS containerToProduct;
...
expiredReport INTEGER);

CREATE TABLE containerToChild
(parentID VARCHAR(12) NOT NULL,
childID VARCHAR(12) NOT NULL);

CREATE TABLE containerToProduct
