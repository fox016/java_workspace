 ...
 */
public class ProductData extends Tagable implements Comparable{
    ...
    public int compareTo(Object o) 
    {
        ...
        {
        	if(((ProductData) o).getDescription().compareTo(this.getDescription()) == 0)
        	{
        		return this.getBarcode().compareTo(((ProductData) o).getBarcode());
        	}
            return this._description.compareTo(((ProductData)o)._description);
        }
        return -1;
    }
    ...
    public boolean equals(Object o)
    {
        if (o instanceof ProductData)
        {
            return this._barcode.equals(((ProductData)o)._barcode);
        }
        return false;
    }
