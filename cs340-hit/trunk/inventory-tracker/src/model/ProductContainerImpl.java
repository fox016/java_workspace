...
public abstract class ProductContainerImpl implements Serializable, ChangableProductContainer
{
	...
	private String name;
        protected Set<ChangableProductContainer> groups;
        protected Set<ProductBarcode> products;
    ...
    public void addContainer(ProductGroup group) throws IllegalArgumentException
	 {
        groups.add((ProductGroupImpl)group);
	 }
    ...
    /**
     * @return A set of longs representing unique ids of children
     */
    public Set<Integer> getChildIDs()
    {
    	...
    	for(ProductContainer container : groups)
    	{
    		toReturn.add(container.getContainerID());
    	}
    	return toReturn;
    }
   
//    /**
//     * Returns child product containers
//     */
//    public Set<ProductContainer> getChildContainers(){
//    	assert(true);
//    	return groups;
//    }
    ...
    */
    ...
    public boolean equals(Object obj) 
    {
        ...
        final ProductContainerImpl other = (ProductContainerImpl) obj;
        if (this.ID != other.ID) 
        {
            return false;
        }
