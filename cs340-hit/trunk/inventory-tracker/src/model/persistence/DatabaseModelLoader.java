...
//		System.out.println(Calendar.getInstance());
	...
	/** This method defines the interface to this object. 
	 * Loads the Model into memory from the database */ 
	...
	private void getItems() throws SQLException
	{
		...
		while(rs.next())
		{
			...
			{
				//System.out.println("NULL Exit Time");
				exit = null;
			}
			else
	...
	private void getProducts() throws SQLException
	{
		...
		while(rs.next())
		{
			...
			Product product =
					new Product(creation, pb, desc, new Size(amount, type), shelf, three);
	...
	/** Uses productAssignments to construct the mapping from PC 
	 * to Products in the model objects */
